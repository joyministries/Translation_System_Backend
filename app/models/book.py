...
class Book(Base, UUIDMixin, TimestampMixin):
    ...
    normalized_docx_path: Mapped[str | None] = mapped_column(String(1000), nullable=True)
    normalized_source_type: Mapped[str | None] = mapped_column(String(100), nullable=True)
    normalization_status: Mapped[str | None] = mapped_column(String(20), nullable=True)
